#!/usr/bin/python3
"""Durable systemd-user supervision for one fair-stability v10 ordinal.
...
from fair_stability_ordinal_common_v10 import (  # noqa: E402
    ...
    valid_prestart_resource_gate_v10,
    valid_ready_prestart_resource_gate_v10,
...
CONTROLLER = ROOT / "scripts/run_fair_stability_next_v10.py"
...
MATRIX_FREEZE = EXPERIMENT_ROOT / "attempt_matrix_freeze_v10.json"
...
UNIT_PREFIX = "aqua-fe-fair-stability-v10"

SUBMISSION_SCHEMA = "aqua-fe-fair-stability-systemd-submission-v10"
SUBMIT_RECEIPT_SCHEMA = "aqua-fe-fair-stability-systemd-submit-receipt-v10"
START_RECEIPT_SCHEMA = "aqua-fe-fair-stability-systemd-start-receipt-v10"
EXECUTION_SCHEMA = "aqua-fe-fair-stability-systemd-execution-v10"
TERMINAL_SCHEMA = "aqua-fe-fair-stability-systemd-terminal-v10"
ADOPTION_CLAIM_SCHEMA = "aqua-fe-fair-stability-systemd-adoption-claim-v10"
ADOPTION_SCHEMA = "aqua-fe-fair-stability-systemd-adoption-v10"
...
def host_preflight() -> dict[str, object]:
    ...
    return {
        "schema_version": "aqua-fe-fair-stability-systemd-host-preflight-v10",
        ...
        "login": {
            ...
            "limitation": (
                "LAST_LOGIN_SESSION_EXIT_MAY_STOP_USER_MANAGER_AND_INVALIDATE_V10"
...
def systemd_run_argv(unit: str, directory: Path) -> list[str]:
    ...
    return [
        ...
        f"--description=AQUA-FE fair-stability v10 one ordinal {unit}",
...
def _runner_check_argv(state: Mapping[str, Any]) -> list[str]:
    from run_fair_stability_next_v10 import runner_argv
...
def poll(directory: Path | None = None) -> dict[str, object]:
    ...
    claim = load_json(selected / "submission_claim.json", SUBMISSION_SCHEMA)
    return {
        "schema_version": "aqua-fe-fair-stability-systemd-poll-v10",
        "experiment_id": EXPERIMENT_ID,
...
def adopt(directory: Path | None = None) -> dict[str, object]:
    ...
    if service_result == "timeout" or exit_code in {"killed", "dumped"}:
        raise SystemdSupervisorError("SYSTEMD_TIMEOUT_OR_SIGNAL_FAIL_STOP_ABANDON_V10")
    ...
    if outcome == TERMINAL_SYSTEMD_OUTCOME:
        from run_fair_stability_next_v10 import adopt_terminal
