#!/usr/bin/env python3
"""One-shot HFNet-SLAM A10 warm-start runability rescue.

Feed canonical source frames 0..2800 continuously and score only the already
selected positive window 2400..2800.  This is development-only runability,
...
FEED_LAST = 2800
FEED_COUNT = 2801
FEED_FIRST_NS = 1542888796062978800
FEED_LAST_NS = 1542888936039921424
SCORE_FIRST = 2400
SCORE_LAST = 2800
SCORE_COUNT = 401
SCORE_FIRST_NS = 1542888916043622160
SCORE_LAST_NS = 1542888936039921424
TIMES_SIZE = 56020
TIMES_SHA256 = "94f7ea8c9cfdfc0af8e5e89efdc19f3c878dd7aaef459a4e97120bedb8048572"
INPUT_PAYLOAD_SHA256 = "2213e27475bf379bc65d9873f242075489faffbb12d52ae8ad03a2611d8839d8"
INPUT_MANIFEST_SIZE = 1847646
INPUT_MANIFEST_SHA256 = "6ed2c86d24942797a81ea21764ec00ea3fb6cd4b17445302717abd3f42a0b4b7"
INPUT_AUDIT_SIZE = 1961070
INPUT_AUDIT_SHA256 = "6f13bea1856513fb7cb083255b299ce548aacf4c0f002ca6eb7f0b18b5b50e78"

MATERIALIZER = ROOT / "scripts/materialize_hfnet_positive_a10_0000_2800_score_2400_2800_warmstart_v1.py"
MATERIALIZER_SIZE = 39236
MATERIALIZER_SHA256 = "93034763c0bc65a19b55e69f0ab53c4b8cad30c67de1399c7b5f3014542c421f"
MATERIALIZER_TEST = ROOT / "scripts/tests/test_materialize_hfnet_positive_a10_0000_2800_score_2400_2800_warmstart_v1.py"
MATERIALIZER_TEST_SIZE = 13701
MATERIALIZER_TEST_SHA256 = "e9db6e8a7a36c7c6495611d5f12cc003fe035efe28601ef8ff237fe2ce0e720e"
SELECTOR = ROOT / "papers/hfnet_v6_a10_0000_2800_score_2400_2800_warmstart_selector_freeze_v1.json"
SELECTOR_SIZE = 2872
SELECTOR_SHA256 = "8ec2f5454f9db9f179c1125f41718a710b35ee85e721e7f696d5d284458fd078"
PROTOCOL = ROOT / "papers/hfnet_v6_a10_0000_2800_score_2400_2800_warmstart_runability_rescue_protocol_v1.md"
PROTOCOL_SIZE = 7447
PROTOCOL_SHA256 = "b55d34d7f0c1eea5992eaeda5b6663fbab335b1dcfa100b235e2d767f93660d4"
...
AUTHORIZATION_TOKEN = "HFNET_V6_A10_0000_2800_SCORE_2400_2800_WARMSTART_ATTEMPT_001_START_EXACTLY_ONCE"
SCHEMA = "aqua-fe-hfnet-v6-a10-0000-2800-score-2400-2800-warmstart-result-v1"
TIMEOUT_SECONDS = 600
...
def paths() -> dict[str, Path]:
    return {
        "subset_times": ATTEMPT / "cam0_times_0000_2800.txt",
        ...
        "score_trajectory": ATTEMPT / "result/trajectory_score_2400_2800.txt",
    }
...
def _fallback_adjudication(error: BaseException) -> dict[str, Any]:
    return {
        "schema_version": "aqua-fe-hfnet-v6-a10-warmstart-score-adjudication-v1",
        "passed": False,
...
def _run_once_impl(token: str) -> dict[str, Any]:
    ...
    claim = {
        "schema_version": "aqua-fe-hfnet-v6-a10-0000-2800-score-2400-2800-warmstart-claim-v1",
...
def profile_atomic_json(path: Path, value: object, exclusive: bool = False) -> None:
    if path == paths()["prepared"] and isinstance(value, dict):
        value["schema_version"] = "aqua-fe-hfnet-v6-a10-0000-2800-score-2400-2800-warmstart-prepared-v1"
        value["scientific_role"] = "DEVELOPMENT_ONLY_HFNET_WARMSTART_RUNABILITY_RESCUE_ON_PRIOR_KLT_POSITIVE_WINDOW"
        value["selection"] = {
            ...
            "history": "warm_start_at_natural_sequence_frame_0; no reset at score frame 2400",
        ...
        value["comparison_boundary"] = {
            ...
            "reason": "HFNet has 0..2399 warm-start history while existing KLT/AQUA-FE rows cold-start at 2400; native reference rows <30",
        }
    elif path == paths()["claim"] and isinstance(value, dict):
        value = dict(value)
        value["schema_version"] = "aqua-fe-hfnet-v6-a10-0000-2800-score-2400-2800-warmstart-claim-v1"
...
def check() -> dict[str, object]:
    ...
    value["schema_version"] = "aqua-fe-hfnet-v6-a10-0000-2800-score-2400-2800-warmstart-check-v1"
    return value
