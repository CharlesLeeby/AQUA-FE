#!/usr/bin/python3
"""Receipt-validated progress summary for runtime-exclusive fair stability v9."""
...
def window_level_analysis(
    ...
    if not (
        ...
        return {
            "schema_version": "aqua-fe-fair-stability-window-analysis-v9",
...
def summarize() -> dict[str, Any]:
    ...
    return {
        "schema_version": "aqua-fe-fair-stability-receipt-summary-v9",
...
def main() -> int:
    report = summarize()
    target = EXPERIMENT_ROOT / "fair_stability_progress_summary_v9.json"
