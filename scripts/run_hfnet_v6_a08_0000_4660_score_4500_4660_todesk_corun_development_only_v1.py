#!/usr/bin/env python3
"""Additive A08 HFNet co-run overlay for ToDesk/ROS/VINS coexistence.

The frozen A08 controller owns the scientific input, source/local index
mapping, 161-frame score adjudication, one-Popen/no-retry supervisor, child
...
from scripts import (  # noqa: E402
    run_hfnet_v6_a08_0000_4660_score_4500_4660_warmstart_v1 as formal,
)
from scripts import (  # noqa: E402
...
FORMAL_RUNNER_SIZE = 41_151
FORMAL_RUNNER_SHA256 = "1f7366ee82374d54760323bc405e1077b5de181419bdee0ee2fcc852cf9e6c65"
FORMAL_RUNNER_TEST = (
    ROOT
    / "scripts/tests/test_run_hfnet_v6_a08_0000_4660_score_4500_4660_warmstart_v1.py"
)
FORMAL_RUNNER_TEST_SIZE = 15_751
FORMAL_RUNNER_TEST_SHA256 = (
    "ec3a0d81b8cc0fd8a02fba2ed659457137db13cd46ae2ac2514d66d0a21671b9"
)
FORMAL_RUNNER_FREEZE = (
    ROOT / "papers/hfnet_v6_a08_0000_4660_score_4500_4660_runner_freeze_v1.json"
)
FORMAL_RUNNER_FREEZE_SIZE = 4_701
FORMAL_RUNNER_FREEZE_SHA256 = (
    "a2ea3a171c33a08d6ea2a68dd3d1681df01164e3897b9b5b46d681f7733f0b88"
)

# Reuse the already exercised A05 resource-policy implementation as a frozen
# helper.  Its configure_overlay()/main() are never called here.
RESOURCE_HELPER = Path(proven_resource.__file__).resolve()
RESOURCE_HELPER_SIZE = 21_293
RESOURCE_HELPER_SHA256 = (
    "d6c2a685c334247e0169118f88640af950c968fc4246bfd34d3f02d7c6b385f5"
)
...
RESOURCE_HELPER_TEST_SIZE = 11_348
RESOURCE_HELPER_TEST_SHA256 = (
    "b0a67850f2c744a4ed745dbf0b4a0ccf7d273a9305c7257bb58cd50389cbd691"
)
RESOURCE_HELPER_FREEZE = (
    ROOT
    / "papers/"
    "hfnet_v6_a05_0001_3700_score_3300_3700_todesk_corun_overlay_freeze_v1.json"
)
RESOURCE_HELPER_FREEZE_SIZE = 4_692
RESOURCE_HELPER_FREEZE_SHA256 = (
    "25111ecaa275ea7881f93762a3a3a6bafb4dbc6539c350205ba1a897b7e4c8f1"
)
...
RUNNER_TEST_SIZE = 17_403
RUNNER_TEST_SHA256 = "6232f6f7b3bf2d63c2f4e8838bb80f020f93baa952be29a9aa205d31dd3d4108"
...
AUTHORIZATION_TOKEN = (
    "HFNET_V6_A08_0000_4660_SCORE_4500_4660_"
...
SCIENTIFIC_ROLE = (
    ...
    "ON_JULY14_A08_OLD_FROZEN_POSITIVE_WINDOW"
)
...
# module bindings.  The A08 installer deliberately restores strict functions;
...
def validate_code_authority() -> dict[str, object]:
    ...
    value["frozen_a08_controller"] = _require_file(
        FORMAL_RUNNER,
        FORMAL_RUNNER_SIZE,
        FORMAL_RUNNER_SHA256,
        "FROZEN_A08_CONTROLLER",
    )
    value["frozen_a08_controller_test"] = _require_file(
        FORMAL_RUNNER_TEST,
        FORMAL_RUNNER_TEST_SIZE,
        FORMAL_RUNNER_TEST_SHA256,
        "FROZEN_A08_CONTROLLER_TEST",
    )
    value["frozen_a08_controller_receipt"] = _require_file(
        FORMAL_RUNNER_FREEZE,
        FORMAL_RUNNER_FREEZE_SIZE,
        FORMAL_RUNNER_FREEZE_SHA256,
        "FROZEN_A08_CONTROLLER_RECEIPT",
    )
    ...
    if not RUNNER_TEST_PIN_READY:
        raise base.ContractError("A08_CORUN_OVERLAY_TEST_IDENTITY_PIN_PENDING")
    value["corun_overlay_test"] = _require_file(
        RUNNER_TEST,
        RUNNER_TEST_SIZE,
        RUNNER_TEST_SHA256,
        "A08_CORUN_OVERLAY_TEST",
    )
    return value
    ...
    value.update(
        {
            ...
            "reason": (
                "HFNet receives source history 0..4499 while historical learned-plus-KLT "
                "and pure-KLT controls cold-start at source 4500; the user-waived co-run "
...
def _install_overlay_profile() -> None:
    """Install A08 first, then rebind the additive resource delta every time."""
    _FORMAL_INSTALL()
...
def _validate_prepared_launch(prepared: Mapping[str, Any]) -> None:
    ...
    if (
        ...
        raise base.ContractError("A08_CORUN_PREPARED_RESOURCE_CONTRACT_MISMATCH")
