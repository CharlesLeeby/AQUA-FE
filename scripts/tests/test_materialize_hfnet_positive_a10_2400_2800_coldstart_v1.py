#!/usr/bin/env python3
"""Process-free tests for the A10 2400..2800 cold-start preparation."""
...
from scripts import materialize_hfnet_positive_a10_2400_2800_coldstart_v1 as adapter
...
class A10ColdstartMaterializerTests(unittest.TestCase):
    def setUp(self) -> None:
