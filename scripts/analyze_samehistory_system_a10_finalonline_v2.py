...
DEFAULT_OUTPUT = (
    ROOT / "papers/samehistory_system_comparison_a10_finalonline_v2_analysis"
)
EXECUTION_LOCK = (
...
def frozen_supervisor_audit_namespace(lock: Mapping[str, Any]) -> dict[str, Any]:
    ...
    supervisor_path = ROOT / "scripts/run_samehistory_system_a10_finalonline_v2.py"
...
def write_report(path: Path, bundle: Mapping[str, Any]) -> None:
    lines = [
        "# A10 same-history final-online experiment v2 analysis",
        "",
