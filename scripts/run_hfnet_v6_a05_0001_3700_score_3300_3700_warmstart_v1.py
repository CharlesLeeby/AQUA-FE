#!/usr/bin/env python3
"""One-shot HFNet-SLAM A05 natural-history runability controller.

Feed legal canonical source frames 1..3700 continuously.  HFNet therefore
numbers them locally as 0..3699.  Score the historical July-14 learned+KLT
positive source window 3300..3700, which is local 3299..3699.  This is
runability-only evidence: history-matched accuracy comparison remains blocked.

Preparation and execution are no-clobber.  A process-start claim authorizes
exactly one HFNet Popen, permits no retry, and is always followed by a terminal
seal even when the child or post-run adjudication fails.
"""
...
ATTEMPT = Path(
    "/mnt/data/AQUA-FE_WS/logs/published_hfnet_slam_v6/old_frozen_positive_windows/"
    "a05_0001_3700_score_3300_3700_warmstart/attempt_001"
)

# Canonical/source and HFNet/local indices are deliberately separate.  The
# official reader sees source frame 1 as its local frame 0.
SOURCE_TO_LOCAL_OFFSET = -1
LOCAL_TO_SOURCE_OFFSET = 1
FEED_SOURCE_FIRST = 1
FEED_SOURCE_LAST = 3700
FEED_LOCAL_FIRST = 0
FEED_LOCAL_LAST = 3699
FEED_COUNT = 3700
FEED_FIRST_NS = 1455214178615853120
FEED_LAST_NS = 1455214363536846272
SCORE_SOURCE_FIRST = 3300
SCORE_SOURCE_LAST = 3700
SCORE_LOCAL_FIRST = 3299
SCORE_LOCAL_LAST = 3699
SCORE_COUNT = 401
# Compatibility aliases used by the inherited hardened adjudicator.  They are
# explicitly HFNet-local, never canonical/source indices.
FEED_FIRST = FEED_LOCAL_FIRST
FEED_LAST = FEED_LOCAL_LAST
SCORE_FIRST = SCORE_LOCAL_FIRST
SCORE_LAST = SCORE_LOCAL_LAST
SCORE_FIRST_NS = 1455214343539451680
SCORE_LAST_NS = 1455214363536846272
PREROLL_LAST_NS = 1455214343489444000
TIMES_SIZE = 74000
TIMES_SHA256 = "93c64e829cc26ff56c9dbff1b5b194c47bebf0a8b35b737bfe79dbb9d64f2468"
INPUT_PAYLOAD_SHA256 = "9ed254e70b0cc830a705adac99f02988fa475946b83310485059e64f4d7b8d66"
INPUT_PAYLOAD_CRC32 = "854c1f78"
INPUT_PAYLOAD_FILE_COUNT = 3703
INPUT_MANIFEST_SIZE = 2432099
INPUT_MANIFEST_SHA256 = "36246dac276f5c737ba40db4e690b377e42d200d34f76b0b3c81a7ca46275315"
INPUT_AUDIT_SIZE = 5822
INPUT_AUDIT_SHA256 = "f9124014a823992b069d22decae0f29023ce97e9e179edbe9ca0917b5734a53b"
INPUT_AUDIT_PIN_READY = True
INPUT_MANIFEST_SCHEMA = "aqua-fe-hfnet-v6-a05-0001-3700-score-3300-3700-input-materialization-v1"
INPUT_AUDIT_SCHEMA = "aqua-fe-hfnet-v6-a05-0001-3700-score-3300-3700-independent-input-audit-v1"

MATERIALIZER = ROOT / "scripts/materialize_hfnet_v6_a05_0001_3700_score_3300_3700_v1.py"
MATERIALIZER_SIZE = 12729
MATERIALIZER_SHA256 = "ed9a9483216b9f4331cd70ec427c9215b7b0a2af222d5c18c3dbeffa39a69b3c"
MATERIALIZER_TEST = ROOT / "scripts/tests/test_materialize_hfnet_v6_a05_0001_3700_score_3300_3700_v1.py"
MATERIALIZER_TEST_SIZE = 6781
MATERIALIZER_TEST_SHA256 = "5cebff021c535596997a69f97aaa190303326c6afa5236e0e18efad6651a51ee"
INPUT_AUDITOR = ROOT / "scripts/audit_hfnet_v6_a05_0001_3700_score_3300_3700_input_v1.py"
INPUT_AUDITOR_SIZE = 46363
INPUT_AUDITOR_SHA256 = "eefa9799b2066d199821c07e034f6db5147108e09b4dc83e0a5277154f0e33eb"
INPUT_AUDITOR_PIN_READY = True
INPUT_AUDITOR_TEST = ROOT / "scripts/tests/test_audit_hfnet_v6_a05_0001_3700_score_3300_3700_input_v1.py"
INPUT_AUDITOR_TEST_SIZE = 4529
INPUT_AUDITOR_TEST_SHA256 = "428e9fda8548def33f77a8b3b3b289422fc5cf4a3047c7aa57140e49427ec3d6"
SELECTOR = ROOT / "papers/hfnet_v6_a05_0001_3700_score_3300_3700_selector_freeze_v1.json"
SELECTOR_SIZE = 4558
SELECTOR_SHA256 = "5533e33720239188c27191ff9eb6bb1aab523b6092240343452f99131512e7f7"
PROTOCOL = ROOT / "papers/hfnet_v6_a05_0001_3700_score_3300_3700_runability_protocol_v1.md"
PROTOCOL_SIZE = 5042
PROTOCOL_SHA256 = "5929fe1761dc6ae55aa51e19456763ed62f31c232ac91e46da3731eb774f606f"
INPUT_FREEZE = ROOT / "papers/hfnet_v6_a05_0001_3700_score_3300_3700_input_freeze_v1.json"
INPUT_FREEZE_SIZE = 6825
INPUT_FREEZE_SHA256 = "69d2fd32985241eb299d7d027136c98c07ce04d4b974d7740acc527725849176"
RUNNER_TEST = ROOT / "scripts/tests/test_run_hfnet_v6_a05_0001_3700_score_3300_3700_warmstart_v1.py"
RUNNER_TEST_SIZE = 18210
RUNNER_TEST_SHA256 = "ca6c7e2940477b77e8d3431fddd42b793a271231b008e070b1f7b8fb36c5db8b"
...
AUTHORIZATION_TOKEN = "HFNET_V6_A05_0001_3700_SCORE_3300_3700_WARMSTART_ATTEMPT_001_START_EXACTLY_ONCE"
SCHEMA = "aqua-fe-hfnet-v6-a05-0001-3700-score-3300-3700-warmstart-result-v1"
PREPARED_SCHEMA = "aqua-fe-hfnet-v6-a05-0001-3700-score-3300-3700-warmstart-prepared-v1"
CLAIM_SCHEMA = "aqua-fe-hfnet-v6-a05-0001-3700-score-3300-3700-warmstart-claim-v1"
CHECK_SCHEMA = "aqua-fe-hfnet-v6-a05-0001-3700-score-3300-3700-warmstart-check-v1"
ADJUDICATION_SCHEMA = "aqua-fe-hfnet-v6-a05-0001-3700-score-3300-3700-warmstart-adjudication-v1"
SCIENTIFIC_ROLE = (
    "DEVELOPMENT_ONLY_HFNET_NATURAL_HISTORY_RUNABILITY_ON_JULY14_OLD_FROZEN_POSITIVE_WINDOW"
)
TIMEOUT_SECONDS = 600
...
def validate_code_authority() -> dict[str, object]:
    ...
    value: dict[str, object] = {
        ...
        "input_freeze": _require_file(
            INPUT_FREEZE, INPUT_FREEZE_SIZE, INPUT_FREEZE_SHA256, "WARMSTART_INPUT_FREEZE"
        ),
        "input_auditor_test": _require_file(
            INPUT_AUDITOR_TEST,
            INPUT_AUDITOR_TEST_SIZE,
            INPUT_AUDITOR_TEST_SHA256,
            "WARMSTART_INPUT_AUDITOR_TEST",
        ),
        "runner_test": _require_file(
            RUNNER_TEST, RUNNER_TEST_SIZE, RUNNER_TEST_SHA256, "WARMSTART_RUNNER_TEST"
        ),
    }
    if INPUT_AUDITOR_PIN_READY:
        value["input_auditor"] = _require_file(
            INPUT_AUDITOR,
            INPUT_AUDITOR_SIZE,
            INPUT_AUDITOR_SHA256,
            "WARMSTART_INPUT_AUDITOR",
        )
    else:
        value["input_auditor"] = {
            "path": str(INPUT_AUDITOR.resolve()),
            "pin_ready": False,
...
def validate_materialization_stage_authority() -> dict[str, Any]:
    """Bind exact materialized bytes to the independent receipt, or stop."""
    code = validate_code_authority()
    if not INPUT_AUDITOR_PIN_READY:
        raise inherited.profile.base.ContractError("A05_INPUT_AUDITOR_IDENTITY_PIN_PENDING")
    if not INPUT_AUDIT_PIN_READY:
        raise inherited.profile.base.ContractError("A05_INPUT_AUDIT_RECEIPT_IDENTITY_PIN_PENDING")
    return {
        "code": code,
...
def paths() -> dict[str, Path]:
    return {
        "subset_times": ATTEMPT / "cam0_times_source_0001_3700_local_0000_3699.txt",
        ...
        "score_trajectory": ATTEMPT / "result/trajectory_score_source_3300_3700.txt",
    }
...
def validate_input_authority() -> dict[str, Any]:
    ...
    # This is intentionally before receipt I/O: until both implementation and
    # receipt identities are frozen, prepare must fail without creating ATTEMPT.
    ...
    if (
        ...
        or selection.get("sequence_id") != "A05"
        ...
        != [FEED_SOURCE_FIRST, FEED_SOURCE_LAST]
        or selection.get("camera_count") != FEED_COUNT
        or selection.get("camera_header_ns_inclusive")
        != [FEED_FIRST_NS, FEED_LAST_NS]
        or selection.get("camera_zero_trimmed_for_missing_shifted_imu_predecessor")
        is not True
        or selection.get("first_legal_camera_source_index") != FEED_SOURCE_FIRST
        or selection.get("preroll_source_camera_indices_inclusive")
        != [FEED_SOURCE_FIRST, SCORE_SOURCE_FIRST - 1]
        or selection.get("preroll_relative_indices_inclusive")
        != [FEED_LOCAL_FIRST, SCORE_LOCAL_FIRST - 1]
        or selection.get("score_source_camera_indices_inclusive")
        != [SCORE_SOURCE_FIRST, SCORE_SOURCE_LAST]
        or selection.get("score_relative_indices_inclusive")
        != [SCORE_LOCAL_FIRST, SCORE_LOCAL_LAST]
        or selection.get("score_camera_count") != SCORE_COUNT
        or selection.get("development_result_conditioned_selection") is not True
        or selection.get("imu_count") != 36958
    ...
    _require_provenance_identity(
        manifest.get("selector_freeze", {}),
        SELECTOR,
        "WARMSTART_MANIFEST_SELECTOR_FREEZE",
    )

    audited_manifest = audit.get("materialization_manifest", {})
    tree_closure = audit.get("tree_closure", {})
    source_audit = audit.get("source", {})
    camera_audit = audit.get("camera", {})
    imu_audit = audit.get("imu", {})
    ...
    if (
        ...
        or source_audit.get("selected_png_members_compared") != FEED_COUNT
        or source_audit.get("selected_png_bytes_equal") is not True
        or source_audit.get("gzip_stream_fully_consumed_and_crc_checked") is not True
        or tree_closure.get("file_count_including_manifest")
        != INPUT_PAYLOAD_FILE_COUNT + 1
        or tree_closure.get("payload_file_count_excluding_manifest")
        != INPUT_PAYLOAD_FILE_COUNT
        or tree_closure.get("exact_file_set") is not True
        or tree_closure.get("exact_directory_set") is not True
        or tree_closure.get("all_entries_regular_or_directories") is not True
        or tree_closure.get("symlinks_present") is not False
        or tree_closure.get("unchanged_during_audit") is not True
        or camera_audit.get("source_indices_inclusive")
        != [FEED_SOURCE_FIRST, FEED_SOURCE_LAST]
        or camera_audit.get("count") != FEED_COUNT
        or camera_audit.get("header_ns_inclusive")
        != [FEED_FIRST_NS, FEED_LAST_NS]
        or camera_audit.get("score_source_indices_inclusive")
        != [SCORE_SOURCE_FIRST, SCORE_SOURCE_LAST]
        or camera_audit.get("score_relative_indices_inclusive")
        != [SCORE_LOCAL_FIRST, SCORE_LOCAL_LAST]
        or camera_audit.get("all_png_bytes_identical_to_canonical_source_members")
        is not True
        or imu_audit.get("selected_count") != 36958
        or imu_audit.get("synthetic_samples_added") is not False
        or imu_audit.get("all_camera_samples_have_predecessor_and_successor")
        is not True
    ...
    _require_provenance_identity(audit.get("auditor", {}), INPUT_AUDITOR, "WARMSTART_AUDITOR")
    _require_provenance_identity(
        audit.get("selector_freeze", {}), SELECTOR, "WARMSTART_AUDIT_SELECTOR_FREEZE"
    )
    ...
    for local_index, row in enumerate(camera_files):
        ...
        if (
            ...
            or row.get("source_index") != local_index + LOCAL_TO_SOURCE_OFFSET
        ):
            raise inherited.profile.base.ContractError(
...
def _parse_pose_rows(path: Path, stamps: Sequence[int]) -> dict[str, Any]:
    ...
    for line_number, raw in enumerate(path.read_text(encoding="ascii").splitlines(), start=1):
        ...
        rows.append(
            {
                "camera_index": index,
                "local_camera_index": index,
                "source_camera_index": index + LOCAL_TO_SOURCE_OFFSET,
                "timestamp_ns": stamp,
                "error_ns": error_ns,
                "line": raw,
            }
...
def _expected_prepared_selection() -> dict[str, Any]:
    return {
        "sequence": "AQUALOC archaeology_sequence_5",
        "feed_source_frame_indices_inclusive": [FEED_SOURCE_FIRST, FEED_SOURCE_LAST],
        "feed_local_frame_indices_inclusive": [FEED_LOCAL_FIRST, FEED_LOCAL_LAST],
        "local_to_source_index_offset": LOCAL_TO_SOURCE_OFFSET,
        "source_to_local_index_offset": SOURCE_TO_LOCAL_OFFSET,
        "preroll_source_frame_indices_inclusive": [
            FEED_SOURCE_FIRST,
            SCORE_SOURCE_FIRST - 1,
        ],
        "preroll_local_frame_indices_inclusive": [
            FEED_LOCAL_FIRST,
            SCORE_LOCAL_FIRST - 1,
        ],
        "preroll_camera_count": SCORE_LOCAL_FIRST - FEED_LOCAL_FIRST,
        "preroll_last_camera_header_ns": PREROLL_LAST_NS,
        "score_source_frame_indices_inclusive": [SCORE_SOURCE_FIRST, SCORE_SOURCE_LAST],
        "score_local_frame_indices_inclusive": [SCORE_LOCAL_FIRST, SCORE_LOCAL_LAST],
        ...
        "camera_zero_excluded_for_input_legality": True,
        "synthetic_or_extrapolated_imu_used": False,
        "history": (
            "continuous_from_first_legal_source_frame_1; HFNet local frame 0; "
            "no reset at score source frame 3300/local frame 3299"
        ),
        "development_result_conditioned_selection": True,
        "held_out_confirmatory_claim_permitted": False,
        "prior_project_result": (
            "July-14 frozen old-arbitration XFeat-plus-KLT short-crop APE "
            "0.358972 m beat pure-KLT 0.373168 m on source 3300..3700"
        ),
    }
...
def _expected_comparison_boundary() -> dict[str, Any]:
    return {
        ...
        "reason": (
            ...
            "and pure-KLT positives cold-start at source 3300; no history-matched comparator "
            "set and frozen common-support evaluator exist yet"
        ),
    }
...
def _feed_index_contract() -> dict[str, Any]:
    return {
        "source_indices_inclusive": [FEED_SOURCE_FIRST, FEED_SOURCE_LAST],
        "local_indices_inclusive": [FEED_LOCAL_FIRST, FEED_LOCAL_LAST],
        "camera_count": FEED_COUNT,
        "local_to_source_index_offset": LOCAL_TO_SOURCE_OFFSET,
    }


def _score_index_contract() -> dict[str, Any]:
    return {
        "source_indices_inclusive": [SCORE_SOURCE_FIRST, SCORE_SOURCE_LAST],
        "local_indices_inclusive": [SCORE_LOCAL_FIRST, SCORE_LOCAL_LAST],
...
def _fallback_adjudication(error: BaseException) -> dict[str, Any]:
    return {
        ...
        "feed": _feed_index_contract(),
        "score": {
            **_score_index_contract(),
            "pose_count": None,
    ...
    return {
        ...
        "score": {
            **_score_index_contract(),
            ...
            "first_source_index": (
                score_indices[0] + LOCAL_TO_SOURCE_OFFSET if score_indices else None
            ),
            "last_source_index": (
                score_indices[-1] + LOCAL_TO_SOURCE_OFFSET if score_indices else None
            ),
    ...
    value.update(
        {
            ...
            "status": (
                "PASS_DEVELOPMENT_RUNABILITY"
                if passed
                else "FAIL_DEVELOPMENT_RUNABILITY"
            ),
...
def _minimal_terminal_failure(
    ...
    return {
        "schema_version": SCHEMA,
        "status": "FAIL_DEVELOPMENT_RUNABILITY",
...
def run_once(token: str) -> dict[str, Any]:
    ...
    try:
        ...
        raw = {
            ...
            "selection": {
                "feed_source_frame_indices_inclusive": [
                    FEED_SOURCE_FIRST,
                    FEED_SOURCE_LAST,
                ],
                "feed_local_frame_indices_inclusive": [FEED_LOCAL_FIRST, FEED_LOCAL_LAST],
                "score_source_frame_indices_inclusive": [
                    SCORE_SOURCE_FIRST,
                    SCORE_SOURCE_LAST,
                ],
                "score_local_frame_indices_inclusive": [
                    SCORE_LOCAL_FIRST,
                    SCORE_LOCAL_LAST,
                ],
            },
