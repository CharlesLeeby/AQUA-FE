#!/usr/bin/env python3
"""Prepare and audit the A10 2400..2800 HFNet cold-start input only.
...
SCHEMA_VERSION = "aqua-fe-hfnet-positive-a10-2400-2800-coldstart-materialization-v1"
AUDIT_SCHEMA_VERSION = (
    "aqua-fe-hfnet-positive-a10-2400-2800-coldstart-independent-audit-v1"
)
...
DEFAULT_SHORT_BAG = ROOT / "datasets/aqualoc/rosbags/archaeo10_2400_2800.bag"
DEFAULT_CONFIG = (
...
SHORT_BAG_SIZE = 108_379_060
SHORT_BAG_SHA256 = "b1989048c7b357958bc351569995275a5f2f71aa873920316733700acd21b6ca"
CONFIG_SIZE = 2_037
...
PRODUCTION_CONTRACT = MaterializationContract(
    ...
    camera_start_index=2_400,
    camera_end_index=2_800,
    camera_first_ns=1_542_888_916_043_622_160,
    ...
    imu_first_index=24_006,
    imu_last_index=28_003,
    imu_first_raw_ns=1_542_888_915_988_397_424,
    imu_last_raw_ns=1_542_888_935_988_415_664,
    imu_first_output_ns=1_542_888_916_042_091_536,
    imu_second_output_ns=1_542_888_916_047_155_312,
    imu_penultimate_output_ns=1_542_888_936_037_078_064,
    imu_last_output_ns=1_542_888_936_042_109_776,
    expected_image_total_bytes=103_016_747,
    expected_source_image_inventory_sha256=(
        "3a0e418870548f49480e3c1e415b357a58f14370512b3999a50b1c6fb9e2577e"
    ),
    expected_source_image_inventory_crc32="bee87f62",
    expected_renamed_image_inventory_sha256=(
        "414393cb4eefa22efa8aa49faa5e5f74b293997d2ddd7d792f1082a5a46f3637"
    ),
    expected_renamed_image_inventory_crc32="7f4ed7b0",
    times_pin=FilePin(
        size_bytes=8_020,
        sha256="7ae37ffc7b7a8802f7a67f541fb8883bd9ed708fe74323b9262e3c73828deced",
        crc32="6d914d2a",
    ),
    camera_csv_pin=FilePin(
        size_bytes=17_669,
        sha256="11ed059ebcf1a024b7664131212ceb32ab1f5e76160a3eb18ef3b09e0ccaa233",
        crc32="0525e0b6",
    ),
    imu_output_pin=FilePin(
        size_bytes=446_502,
        sha256="db114ab49eaba9d7879863e97955585d0ddb78eed48543827f71449dc4bd096f",
        crc32="1907ae21",
    ),
    expected_payload_sha256=(
        "ba1400536382aed9e69e64e514dd3770f1cdb20d42215251576ded3789c29d46"
    ),
    expected_payload_crc32="2aeca045",
)
            ...
            "rejected_alternative": {
                **bag,
                ...
                "camera_header_ns_inclusive": [
                    1_542_888_916_043_622_160,
                    1_542_888_936_039_921_424,
                ],
