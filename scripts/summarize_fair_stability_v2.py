#!/usr/bin/python3
"""Receipt-validated progress summary for runtime-exclusive fair stability v2."""
...
def summarize() -> dict[str, Any]:
    ...
    return {
        "schema_version": "aqua-fe-fair-stability-receipt-summary-v2",
...
def main() -> int:
    report = summarize()
    target = EXPERIMENT_ROOT / "fair_stability_progress_summary_v2.json"
