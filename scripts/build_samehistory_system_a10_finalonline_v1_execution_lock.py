#!/usr/bin/env python3
"""Build (but never overwrite) the A10 final-online execution lock."""
...
RAW = EXP / "raw/archaeo10_0000_2800.bag"
...
DEFAULT_OUTPUT = ROOT / "papers/samehistory_system_comparison_a10_finalonline_v1_execution_lock.candidate.json"
CHANNELS = [
...
def item_contracts() -> dict[str, dict[str, Any]]:
    ...
    klt_link = ROOT / "logs/aqualoc_archaeo_vins/external_klt_every2_systemfair_a10_finalonline_v1_feed0000_2800_klt_export"
    vanilla_link = ROOT / "logs/aqualoc_archaeo_vins/origin_klt_every1_systemfair_a10_finalonline_v1_feed0000_2800_score2400_2800_vanilla_origin"
    external_link = ROOT / "logs/aqualoc_archaeo_vins/external_klt_every2_systemfair_a10_finalonline_v1_feed0000_2800_score2400_2800_external_klt"
    aqua_link = ROOT / "logs/aqualoc_archaeo_vins/external_hybrid_xfeat_every2_systemfair_a10_finalonline_v1_feed0000_2800_score2400_2800_aquafe_finalonline_xfeat_lineage"
    ...
    contracts: dict[str, dict[str, Any]] = {
        "klt_export": {
            ...
            "env": {
                **common,
                "TAG": "systemfair_a10_finalonline_v1_feed0000_2800_klt_export",
        ...
        "aquafe_build": {
            ...
            "output_dir": str(AQUA),
            "workspace_link": str(ROOT / "logs/aqualoc_archaeo_vins/aquafe_finalonline_xfeat_lineage_systemfair_a10_finalonline_v1_feed0000_2800_build"),
            "output_tree_policy": "REQUIRE_EMPTY_BEFORE_CLAIM",
            "archival_outputs": {},
        ...
        "vanilla_origin_native_image_context": {
            ...
            "env": {**backend_common,
                "TAG": "systemfair_a10_finalonline_v1_feed0000_2800_score2400_2800_vanilla_origin",
                "PORT": "11971"},
        ...
        "external_klt_finalonline_backbone": {
            ...
            "env": {**backend_common,
                ...
                "TAG": "systemfair_a10_finalonline_v1_feed0000_2800_score2400_2800_external_klt",
                "PORT": "11973"},
        ...
        "aquafe_finalonline_xfeat_lineage": {
            ...
            "env": {**backend_common,
                ...
                "TAG": "systemfair_a10_finalonline_v1_feed0000_2800_score2400_2800_aquafe_finalonline_xfeat_lineage",
                "PORT": "11974"},
...
def identities() -> dict[str, dict[str, Any]]:
    fixed = {
        ...
        "analysis_only_analyzer": ROOT / "scripts/analyze_samehistory_system_a10_finalonline_v1.py",
...
def build() -> dict[str, Any]:
    ...
    return {
        ...
        "created_at_local": "2026-08-24T19:09:29+08:00",
        ...
        "policy": {
            ...
            "output_tree_policy": {
                ...
                "supervisor_control_files": [
                    "process_start_claim.json", "formal_run_receipt_v1.json",
