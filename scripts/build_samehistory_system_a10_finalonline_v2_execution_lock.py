#!/usr/bin/env python3
"""Build (but never overwrite) the A10 final-online v2 execution lock."""
...
EXP = Path("/mnt/data/AQUA-FE_WS/experiments/a10_samehistory_system_v2")
# v2 is an infrastructure-only relaunch.  Reuse the already audited immutable
# v1 raw input rather than rematerializing or relinking the 766 MB bag.
RAW = Path(
    "/mnt/data/AQUA-FE_WS/experiments/a10_samehistory_system_v1/raw/"
    "archaeo10_0000_2800.bag"
)
KLT = EXP / "frontends/klt_export"
AQUA = EXP / "frontends/aquafe_finalonline"
PROTOCOL = ROOT / "papers/samehistory_system_comparison_a10_finalonline_v2_protocol.md"
DEFAULT_OUTPUT = ROOT / "papers/samehistory_system_comparison_a10_finalonline_v2_execution_lock.candidate.json"
CHANNELS = [
...
def item_contracts() -> dict[str, dict[str, Any]]:
    ...
    klt_link = ROOT / "logs/aqualoc_archaeo_vins/external_klt_every2_systemfair_a10_finalonline_v2_feed0000_2800_klt_export"
    vanilla_link = ROOT / "logs/aqualoc_archaeo_vins/origin_klt_every1_systemfair_a10_finalonline_v2_feed0000_2800_score2400_2800_vanilla_origin"
    external_link = ROOT / "logs/aqualoc_archaeo_vins/external_klt_every2_systemfair_a10_finalonline_v2_feed0000_2800_score2400_2800_external_klt"
    aqua_link = ROOT / "logs/aqualoc_archaeo_vins/external_hybrid_xfeat_every2_systemfair_a10_finalonline_v2_feed0000_2800_score2400_2800_aquafe_finalonline_xfeat_lineage"
    ...
    contracts: dict[str, dict[str, Any]] = {
        "klt_export": {
            "kind": "frontend_export", "dependencies": [], "timeout_seconds": 5400,
            "argv": ["/usr/bin/bash", wrapper, "aqualoc_archaeo_loftr_mirror_klt", "10", "0", "2800"],
            "env": {
                **common,
                "TAG": "systemfair_a10_finalonline_v2_feed0000_2800_klt_export",
                "RUN_VINS": "0", "FORCE_RAW": "0", "FORCE_EXPORT": "1",
                "LOFTR_MIRROR_CONFIG": str(ROOT / "uw_frontend/configs/experiments/formal_loftr_mirror_contribution_v33_frontend.yaml"),
                "MEASUREMENT_SELECTION": "0", "EXPORT_MAX_FEATURES": "350",
                "FRAME_OFFSET": "1", "PROCESS_SKIPPED_FRAMES": "1",
                "INIT_PARALLAX_ADAPTIVE_SKIP": "0",
                "BACKEND_QUALITY_MODE": "source_aware", "BACKEND_QUALITY_ALPHA": "0.85",
                "BACKEND_QUALITY_FLOOR": "0.80", "OMP_NUM_THREADS": "2",
                "MKL_NUM_THREADS": "2", "OPENBLAS_NUM_THREADS": "2",
            },
            "output_dir": str(KLT), "workspace_link": str(klt_link),
            "output_tree_policy": "REQUIRE_EMPTY_BEFORE_CLAIM",
            "archival_outputs": {},
            "expected_outputs": ["features.bag", "frontend_metrics.csv", "aqualoc_archaeo10_pinhole.yaml"],
            "semantic_checks": [
                {
        ...
        "aquafe_build": {
            "kind": "learned_sidecar_build", "dependencies": ["klt_export"],
            ...
            "output_dir": str(AQUA),
            "workspace_link": str(ROOT / "logs/aqualoc_archaeo_vins/aquafe_finalonline_xfeat_lineage_systemfair_a10_finalonline_v2_feed0000_2800_build"),
            "output_tree_policy": "REQUIRE_EMPTY_BEFORE_CLAIM",
            "archival_outputs": {},
        ...
        "vanilla_origin_native_image_context": {
            "kind": "backend_replay", "dependencies": [], "timeout_seconds": 1200,
            "argv": ["/usr/bin/bash", runner, "origin", "10", "0", "2800", "klt", "1"],
            "env": {**backend_common,
                "TAG": "systemfair_a10_finalonline_v2_feed0000_2800_score2400_2800_vanilla_origin",
                "PORT": "11971"},
        ...
        "external_klt_finalonline_backbone": {
            "kind": "backend_replay", "dependencies": ["klt_export"], "timeout_seconds": 1200,
            "argv": ["/usr/bin/bash", runner, "external", "10", "0", "2800", "klt", "2"],
            "env": {**backend_common,
                "FEATURE_BAG_OVERRIDE": str(KLT / "features.bag"),
                "TAG": "systemfair_a10_finalonline_v2_feed0000_2800_score2400_2800_external_klt",
                "PORT": "11973"},
        ...
        "aquafe_finalonline_xfeat_lineage": {
            "kind": "backend_replay", "dependencies": ["aquafe_build"], "timeout_seconds": 1200,
            "argv": ["/usr/bin/bash", runner, "external", "10", "0", "2800", "hybrid_xfeat", "2"],
            "env": {**backend_common,
                "FEATURE_BAG_OVERRIDE": str(AQUA / "full_merged.bag"),
                "TAG": "systemfair_a10_finalonline_v2_feed0000_2800_score2400_2800_aquafe_finalonline_xfeat_lineage",
                "PORT": "11974"},
    ...
    authority_keys = {
        "klt_export": [
            "bash", "python3_8", "profile_wrapper", "archaeology_runner",
            "feature_exporter", "aqualoc_raw_converter", "v33_config", "raw_bag",
            "raw_tar", "ground_truth", "opencv_python_binary", "numpy_python_entry",
            "rosbag_python_entry", "vins_setup_bash", "vins_setup_sh",
    ...
    dependency_artifacts = {
        "klt_export": {},
        "aquafe_build": {
            "base_bag": {"dependency": "klt_export", "relative_path": "features.bag"},
            "camera_config": {
                "dependency": "klt_export", "relative_path": "aqualoc_archaeo10_pinhole.yaml",
            },
        },
        "vanilla_origin_native_image_context": {},
        "external_klt_finalonline_backbone": {
            "feature_bag": {"dependency": "klt_export", "relative_path": "features.bag"},
            "frontend_metrics": {
                "dependency": "klt_export", "relative_path": "frontend_metrics.csv",
            },
        },
        "aquafe_finalonline_xfeat_lineage": {
...
def identities() -> dict[str, dict[str, Any]]:
    fixed = {
        ...
        "supervisor": ROOT / "scripts/run_samehistory_system_a10_finalonline_v2.py",
        "analysis_only_analyzer": ROOT / "scripts/analyze_samehistory_system_a10_finalonline_v2.py",
...
def build() -> dict[str, Any]:
    ...
    return {
        ...
        "created_at_local": "2026-08-24T19:17:43+08:00",
        ...
        "policy": {
            ...
            "output_tree_policy": {
                ...
                "supervisor_control_files": [
                    "process_start_claim.json", "formal_run_receipt_v2.json",
