...
RUNTIME_ROOT="/media/ma/Data/AQUA-FE_WS_storage_offload/frontend_coverage_monotone_router_v2"
...
{
  printf 'schema_version=aqua-fe-coverage-monotone-v2-backend-cell-v1\n'
  printf 'window_id=%s\n' "$WINDOW_ID"
  printf 'run_slug=%s\n' "$RUN_SLUG"
  printf 'cell_id=%s\n' "$CELL_ID"
  printf 'repeat=%s\n' "$REPEAT"
