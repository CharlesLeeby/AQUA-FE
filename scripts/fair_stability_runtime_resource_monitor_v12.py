#!/usr/bin/python3
"""Continuous resource-exclusivity evidence for fair-stability v12 runs.
...
PRESTART_RESOURCE_GATE_SCHEMA = (
    "aqua-fe-fair-stability-prestart-resource-gate-v12"
)
...
def _classify_gpu_applications(
    ...
    for source in applications:
        ...
        # Deliberately no ToDesk or desktop-process exemption in v12.
        external.append(row)
    return {
        "external": external,
...
def resource_gate(
    ...
    """Run the strict v12 pre-start exclusivity gate.
