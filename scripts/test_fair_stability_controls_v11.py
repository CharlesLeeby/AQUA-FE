...
VINS = load("fair_vins_v11", SCRIPTS / "run_fair_stability_vins_replay_v11.py")
HFNET = load("fair_hfnet_v11", SCRIPTS / "run_fair_stability_hfnet_openloop_v11.py")
ORDINAL = load("fair_ordinal_v11", SCRIPTS / "fair_stability_ordinal_common_v11.py")
NEXT = load("fair_next_v11", SCRIPTS / "run_fair_stability_next_v11.py")
SUMMARY = load("fair_summary_v11", SCRIPTS / "summarize_fair_stability_v11.py")
RESOURCE = load(
    "fair_runtime_resource_monitor_v11",
    SCRIPTS / "fair_stability_runtime_resource_monitor_v11.py",
)
SYSTEMD = load(
    "fair_systemd_supervisor_v11",
    SCRIPTS / "run_fair_stability_systemd_supervisor_v11.py",
)
...
class LifecycleAndScheduleTests(unittest.TestCase):
    def test_vins_lifecycle_exact_identity(self) -> None:
        with tempfile.TemporaryDirectory() as temporary:
            ...
            start_values = {
                "schema_version": "aqua-fe-fair-stability-vins-child-start-v11",
            ...
            lifecycle_values.update(
                {
                    "schema_version": "aqua-fe-fair-stability-vins-child-lifecycle-v11",
    ...
    def test_v11_schedule_and_pristine_attempt_matrix(self) -> None:
        with tempfile.TemporaryDirectory() as temporary:
            root = Path(temporary)
            ...
            matrix_path = root / "attempt_matrix_freeze_v11.json"
...
class V11ControlRegressionTests(unittest.TestCase):
    def test_v11_control_document_identities_and_history_are_pinned(self) -> None:
    ...
    def test_v11_controls_never_read_predecessor_runtime_or_attempt_namespaces(self) -> None:
        controls = (
            "fair_stability_ordinal_common_v11.py",
            "fair_stability_runtime_resource_monitor_v11.py",
            "run_fair_stability_hfnet_openloop_v11.py",
            "run_fair_stability_vins_replay_v11.py",
            "run_fair_stability_next_v11.py",
            "run_fair_stability_systemd_supervisor_v11.py",
            "run_fair_stability_vins_replay_child_v11.sh",
            "summarize_fair_stability_v11.py",
        )
        forbidden = (
    ...
    def test_v10_non_import_flags_fail_closed_in_freeze_readers(self) -> None:
        claims = {
            **{
                f"v{version}_results_imported": False
                for version in range(1, 11)
        ...
        self.assertTrue(ORDINAL.valid_v10_non_import_claims(claims))
        with tempfile.TemporaryDirectory() as temporary:
            freeze_path = Path(temporary) / "backend_freeze.json"
            for key in sorted(ORDINAL.V10_NON_IMPORT_CLAIM_KEYS):
                for mutation in ("missing", "true"):
                    with self.subTest(key=key, mutation=mutation):
                        ...
                        self.assertFalse(
                            ORDINAL.valid_v10_non_import_claims(invalid_claims)
                        )
                            ...
                            ORDINAL.canonical_json(
                                {
                                    "schema_version": (
                                        ...
                                        "runtimeexcl-backend-freeze-v11"
                                    ),
                                    "experiment_id": ORDINAL.EXPERIMENT_ID,
                                    "backend_id": (
                                        "DEV_NATIVEQ_SCHEDFIX_RUNTIMEEXCL_V11"
                                    ),
    ...
    def test_vins_roscore_interpreter_is_fixed_not_manifest_selected(self) -> None:
        ...
        wrapper = (
            SCRIPTS / "run_fair_stability_vins_replay_child_v11.sh"
    ...
    CHILD = SCRIPTS / "run_fair_stability_vins_replay_child_v11.sh"
    ...
    def test_vins_rejects_prior_result_import_claims(self) -> None:
        ...
        manifest = {
            "schema_version": "aqua-fe-fair-stability-hfnet-input-freeze-v11",
        ...
        with tempfile.TemporaryDirectory() as temporary:
            ...
            with mock.patch.object(VINS, "EXPERIMENT_ROOT", root), mock.patch.object(
                ...
                VINS, "read_csv_rows", side_effect=[roster, historical] * 20
            ), mock.patch.object(
    ...
    def test_runner_summaries_delegate_to_receipt_state_machine(self) -> None:
        ...
        with mock.patch(
            "summarize_fair_stability_v11.summarize", return_value=sentinel
        ) as summarize:
    ...
    def test_postprocess_signals_remain_fail_stop_through_result_publication(self) -> None:
        ...
        for path in (
            SCRIPTS / "run_fair_stability_hfnet_openloop_v11.py",
            SCRIPTS / "run_fair_stability_vins_replay_v11.py",
        ):
    ...
    def test_result_published_then_runner_signal_is_controller_fail_stop(self) -> None:
        with tempfile.TemporaryDirectory() as temporary:
            ...
            matrix = base / "attempt_matrix_freeze_v11.json"
            matrix.write_text("{}\n", encoding="ascii")
            dispatch_claim = attempt / "ordinal_dispatch_claim.json"
            dispatch_claim.write_text("{}\n", encoding="ascii")
            attempt_manifest = {
                "schema_version": "synthetic-attempt-v11",
                "experiment_id": ORDINAL.EXPERIMENT_ID,
                "port": 26100,
            }
            ...
            def fake_run(
                ...
                (attempt / "run_result.json").write_bytes(
                    ORDINAL.canonical_json(
                        {
                            "schema_version": "aqua-fe-fair-stability-vins-result-v11",
                            "experiment_id": ORDINAL.EXPERIMENT_ID,
                            "case_id": "a05_3300_3700",
                            "arm": "learned_klt_vins",
                            "repeat": 1,
    ...
    def test_resource_check_stdout_then_signal_cannot_start_estimator(self) -> None:
        state = {
            "state": "READY",
            "attempt_root": "/tmp/never-started-v11",
            "attempt_index": 1,
            "cell": {
                "ordinal": 1,
                "case_id": "a05_3300_3700",
        ...
        gate = {
            "schema_version": "aqua-fe-fair-stability-prestart-resource-gate-v11",
            "experiment_id": ORDINAL.EXPERIMENT_ID,
            "ready": True,
        }
    ...
    def test_terminal_adoption_has_bound_monitor_and_two_validations(self) -> None:
        with tempfile.TemporaryDirectory() as temporary:
            ...
            claim = {
                "schema_version": "aqua-fe-fair-stability-systemd-adoption-claim-v11",
    ...
    def test_matrix_freeze_requires_exact_pristine_prepare_tree(self) -> None:
        ...
        def prepare_fixture(experiment_root: Path) -> tuple[Path, Path]:
            ...
            manifest = {
                "schema_version": "aqua-fe-fair-stability-hfnet-attempt-v11",
                "experiment_id": ORDINAL.EXPERIMENT_ID,
                "case_id": cell["case_id"],
                "arm": cell["arm"],
                "repeat": 1,
...
class SystemdControlTests(unittest.TestCase):
    ...
    def build_chain(
        ...
        unit = (
            f"aqua-fe-fair-stability-v11-o{planned_ordinal:03d}-a001-"
        ...
        if actual_outcome == ORDINAL.TERMINAL_SYSTEMD_OUTCOME:
            ...
            ordinal_path.write_bytes(
                ORDINAL.canonical_json(
                    {
                        "schema_version": (
                            "aqua-fe-fair-stability-ordinal-terminal-v11"
                        ),
                        "experiment_id": ORDINAL.EXPERIMENT_ID,
                        "planned_ordinal": claim["planned_ordinal"],
        ...
        if outcome == "RESOURCE_BLOCKED_NO_START":
            ...
            dispatch = {
                ...
                "controller": ORDINAL.identity(
                    SCRIPTS / "run_fair_stability_next_v11.py"
                ),
                "run_result": None,
    ...
    def test_systemd_unit_contract_and_submit_only_argv(self) -> None:
        with tempfile.TemporaryDirectory() as temporary:
            ...
            unit = "aqua-fe-fair-stability-v11-o001-a001-s001-aabbcc.service"
    ...
    def test_systemd_user_control_plane_uses_fixed_bus_under_empty_ambient_env(
        ...
        with mock.patch.dict(os.environ, {}, clear=True), mock.patch.object(
            ...
            observed = SYSTEMD.query_unit("aqua-fe-fair-stability-v11-test.service")
        self.assertEqual(
    ...
    def test_pipeline_invalid_second_submission_is_rejected_zero_retry(self) -> None:
        with tempfile.TemporaryDirectory() as temporary:
            ...
            invalid_receipt = {
                "schema_version": (
                    "aqua-fe-fair-stability-pipeline-invalid-adjudication-v11"
                ),
                "experiment_id": ORDINAL.EXPERIMENT_ID,
    ...
    def test_no_start_adoption_never_calls_terminal_adoption(self) -> None:
        with tempfile.TemporaryDirectory() as temporary:
            ...
            import run_fair_stability_next_v11 as canonical_next
    ...
    def test_blocked_resource_gate_is_complete_at_all_three_boundaries(
        ...
        for label, gate in attacked_gates():
            with self.subTest(layer="shared", attack=label):
                self.assertFalse(
                    ORDINAL.valid_prestart_resource_gate_v11(
                        gate,
    ...
    def boundary(self, root: Path) -> dict[str, dict[str, object]]:
        ...
        return {
            "common": ORDINAL.identity(
                SCRIPTS / "fair_stability_ordinal_common_v11.py"
            ),
            "controller": ORDINAL.identity(
                SCRIPTS / "run_fair_stability_next_v11.py"
            ),
    ...
    def build_terminal(
        ...
        manifest_path.write_bytes(
            ORDINAL.canonical_json(
                {
                    "schema_version": (
                        "aqua-fe-fair-stability-vins-attempt-v11"
                    ),
                    "experiment_id": ORDINAL.EXPERIMENT_ID,
                    "case_id": cell["case_id"],
                    "arm": cell["arm"],
        ...
        result.update(
            {
                "schema_version": (
                    "aqua-fe-fair-stability-vins-result-v11"
                ),
                "experiment_id": ORDINAL.EXPERIMENT_ID,
                "case_id": cell["case_id"],
                "arm": cell["arm"],
...
class ZeroKfWatchdogTests(unittest.TestCase):
    ...
    def test_refused_final_gate_is_preserved_but_is_not_an_action(self) -> None:
        with tempfile.TemporaryDirectory() as temporary:
            ...
            outcome = {
                "schema_version": (
                    "aqua-fe-fair-stability-hfnet-zero-kf-watchdog-outcome-v11"
                ),
                "monitor_proven": False,
                "monitoring_errors": [
                    "FINAL_SIGNAL_GATE:"
    ...
    def test_common_watchdog_chain_rejects_contradictory_signal_proofs(self) -> None:
        with tempfile.TemporaryDirectory() as temporary:
            ...
            launch = {
                "schema_version": "aqua-fe-fair-stability-hfnet-launch-receipt-v11",
                "experiment_id": ORDINAL.EXPERIMENT_ID,
                "valid": True,
                "errors": [],
                "pid": 4242,
            ...
            def runtime_receipt(returncode, cleanup_actions):
                return {
                    "schema_version": (
                        "aqua-fe-fair-stability-runtime-resource-monitor-v11"
                    ),
                    "experiment_id": ORDINAL.EXPERIMENT_ID,
                    "coverage": {"process_group_empty": True},
                    "supervised_process": {
            ...
            receipt = {
                "schema_version": (
                    "aqua-fe-fair-stability-hfnet-zero-kf-post-shutdown-watchdog-v11"
                ),
                "experiment_id": ORDINAL.EXPERIMENT_ID,
            ...
            passive = {
                ...
                "reap": {
                    "schema_version": (
                        "aqua-fe-fair-stability-same-popen-reap-v11"
                    ),
