#!/usr/bin/env python3
"""Fail-closed one-shot supervisor for the frozen A10 same-history run.
...
EXP_ROOT = Path("/mnt/data/AQUA-FE_WS/experiments/a10_samehistory_system_v1")
DEFAULT_LOCK = ROOT / "papers/samehistory_system_comparison_a10_finalonline_v1_execution_lock.json"
...
WORKSPACE_LINKS = {
    "klt_export": ROOT / "logs/aqualoc_archaeo_vins/external_klt_every2_systemfair_a10_finalonline_v1_feed0000_2800_klt_export",
    "aquafe_build": ROOT / "logs/aqualoc_archaeo_vins/aquafe_finalonline_xfeat_lineage_systemfair_a10_finalonline_v1_feed0000_2800_build",
    "vanilla_origin_native_image_context": ROOT / "logs/aqualoc_archaeo_vins/origin_klt_every1_systemfair_a10_finalonline_v1_feed0000_2800_score2400_2800_vanilla_origin",
    "external_klt_finalonline_backbone": ROOT / "logs/aqualoc_archaeo_vins/external_klt_every2_systemfair_a10_finalonline_v1_feed0000_2800_score2400_2800_external_klt",
    "aquafe_finalonline_xfeat_lineage": ROOT / "logs/aqualoc_archaeo_vins/external_hybrid_xfeat_every2_systemfair_a10_finalonline_v1_feed0000_2800_score2400_2800_aquafe_finalonline_xfeat_lineage",
}
...
# cycle.
EXPECTED_CONTRACT_SHA256 = "6376d84f769ac271aa5e7945901a87172b0e9918c39bd573fa54c75fdad81a44"
...
def validate_items(lock: Mapping[str, Any], verified: Mapping[str, Mapping[str, Any]]) -> None:
    ...
    required_static_paths = {
        ...
        ROOT / "scripts/analyze_samehistory_system_a10_finalonline_v1.py",
...
def verify_lock(path: Path) -> tuple[dict[str, Any], dict[str, dict[str, Any]], dict[str, Any]]:
    ...
    if builder is None or Path(builder["path"]).absolute() != ROOT / "scripts/build_samehistory_system_a10_finalonline_v1_execution_lock.py":
