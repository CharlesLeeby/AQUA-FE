#!/usr/bin/python3
"""Continuous resource-exclusivity evidence for fair-stability v5 runs.
...
def _classify_gpu_applications(
    ...
    for source in applications:
        ...
        # Deliberately no ToDesk or desktop-process exemption in v5.
        external.append(row)
    return {
        "external": external,
...
def resource_gate(
    ...
    """Run the strict v5 pre-start exclusivity gate.
    ...
    return {
        "schema_version": "aqua-fe-fair-stability-prestart-resource-gate-v5",
