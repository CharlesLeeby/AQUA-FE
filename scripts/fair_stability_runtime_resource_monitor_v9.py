#!/usr/bin/python3
"""Continuous resource-exclusivity evidence for fair-stability v9 runs.
...
PRESTART_RESOURCE_GATE_SCHEMA = (
    "aqua-fe-fair-stability-prestart-resource-gate-v9"
)
...
def _classify_gpu_applications(
    ...
    for source in applications:
        ...
        # Deliberately no ToDesk or desktop-process exemption in v9.
        external.append(row)
    return {
        "external": external,
...
def resource_gate(
    ...
    """Run the strict v9 pre-start exclusivity gate.
