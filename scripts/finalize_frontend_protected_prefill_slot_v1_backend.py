#!/usr/bin/env python3
"""Reduce EXP-20260906-009 and apply its frozen development decision."""
...
import run_frontend_protected_prefill_slot_v1_backend as runner
        ...
        output.append(
            {
                ...
                "backend_execution": (
                    "INDEPENDENT_NEW_PROTECTED_PREFILL_REPLAY"
                    if action
        ...
        output.append(
            {
                ...
                "backend_execution": "INDEPENDENT_NEW_PROTECTED_PREFILL_REPLAY",
...
def main() -> int:
    ...
    decision = {
        "schema_version": (
            "aqua-fe-protected-prefill-slot-v1-development-decision-v1"
        ),
        ...
        "next_step": (
            ...
            if expand
                ...
                "Do not expand or try a second slot budget/order/timing variant; "
                "report this protected pre-refill mechanism as unsupported."
            )
        ),
    }
