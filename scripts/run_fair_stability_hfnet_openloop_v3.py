#!/usr/bin/python3
"""Prepare and run the open-loop HFNet arms of runtime-exclusive v3.
...
RUNTIME_EXCLUSIVITY_ADDENDUM = (
    ROOT / "papers/fair_stability_runtime_exclusivity_addendum_v3.md"
)
...
RUNTIME_RESOURCE_MONITOR = (
    ROOT / "scripts/fair_stability_runtime_resource_monitor_v3.py"
)
...
EXPECTED_CONTROL_DOCUMENTS = {
    "runtime_exclusivity_addendum": (
        RUNTIME_EXCLUSIVITY_ADDENDUM,
        9_837,
        "b14fe53e492ce23e984827d4f0ed4e022c28afb9224eae628dbe88ab510f7e5a",
    ),
    "v1_runtime_contamination_report": (
        V1_RUNTIME_CONTAMINATION_REPORT,
        3_436,
    ...
    "control_supersession": (
        CONTROL_SUPERSESSION,
        4_160,
        "08af09d6707e6fb8d6d45ee9d476a348072bf97a23b67d41f351dac764ead854",
    ),
    "shutdown_addendum": (
        SHUTDOWN_ADDENDUM,
        1_645,
...
def load_experiment() -> dict[str, Any]:
    ...
    if manifest.get("schema_version") != "aqua-fe-fair-stability-hfnet-input-freeze-v3":
...
def prepare_attempt(
    ...
    *,
    ...
    try:
        ...
        attempt = {
            "schema_version": "aqua-fe-fair-stability-hfnet-attempt-v3",
            "experiment_id": EXPERIMENT_ID,
...
def verify_attempt(
    ...
    if attempt.get("schema_version") != "aqua-fe-fair-stability-hfnet-attempt-v3":
...
def process_start_receipt(process: subprocess.Popen[bytes], attempt: Mapping[str, Any]) -> dict[str, object]:
    ...
    return {
        "schema_version": "aqua-fe-fair-stability-hfnet-launch-receipt-v3",
        "experiment_id": EXPERIMENT_ID,
        "valid": not errors,
        "errors": errors,
        "pid": process.pid,
...
def run_attempt(case_id: str, budget: int, repeat: int, attempt_index: int = 1) -> dict[str, object]:
    ...
    with lock_path.open("r+b") as lock_stream:
        ...
        claim = {
            "schema_version": "aqua-fe-fair-stability-hfnet-start-claim-v3",
            "experiment_id": EXPERIMENT_ID,
        ...
        result = {
            "schema_version": "aqua-fe-fair-stability-hfnet-result-v3",
            "experiment_id": EXPERIMENT_ID,
            "status": status,
