#!/usr/bin/python3
"""Receipt-validated progress summary for runtime-exclusive fair stability v6."""
...
def window_level_analysis(
    ...
    result: dict[str, Any] = {
        "schema_version": "aqua-fe-fair-stability-window-analysis-v6",
...
def summarize() -> dict[str, Any]:
    ...
    return {
        "schema_version": "aqua-fe-fair-stability-receipt-summary-v6",
...
def main() -> int:
    report = summarize()
    target = EXPERIMENT_ROOT / "fair_stability_progress_summary_v6.json"
