#!/usr/bin/python3
"""Prepare and run the open-loop HFNet arms of runtime-exclusive v5.
...
RUNTIME_EXCLUSIVITY_ADDENDUM = (
    ROOT / "papers/fair_stability_runtime_exclusivity_addendum_v5.md"
)
...
RUNTIME_RESOURCE_MONITOR = (
    ROOT / "scripts/fair_stability_runtime_resource_monitor_v5.py"
)
...
EXPECTED_CONTROL_DOCUMENTS = {
    "runtime_exclusivity_addendum": (
        RUNTIME_EXCLUSIVITY_ADDENDUM,
        14_590,
        "904563647667de129107a2ba97e8ff25fc2aa6a1ae3db192177f94d636ff4e05",
    ),
    "v1_runtime_contamination_report": (
        V1_RUNTIME_CONTAMINATION_REPORT,
        3_436,
    ...
    "control_supersession": (
        CONTROL_SUPERSESSION,
        7_837,
        "27f2b0919e2bdefbb4e07ae695be5ded7ef6986fa66c62a02dada680cf139c7d",
    ),
...
ZERO_KF_WATCHDOG_SCHEMA = (
    "aqua-fe-fair-stability-hfnet-zero-kf-post-shutdown-watchdog-v5"
)
...
def freeze_inputs() -> dict[str, object]:
    ...
    try:
        ...
        manifest = {
            "schema_version": "aqua-fe-fair-stability-hfnet-input-freeze-v5",
...
def load_experiment() -> dict[str, Any]:
    ...
    if manifest.get("schema_version") != "aqua-fe-fair-stability-hfnet-input-freeze-v5":
...
def prepare_attempt(
    ...
    *,
    ...
    try:
        ...
        attempt = {
            "schema_version": "aqua-fe-fair-stability-hfnet-attempt-v5",
            "experiment_id": EXPERIMENT_ID,
...
def verify_attempt(
    ...
    if attempt.get("schema_version") != "aqua-fe-fair-stability-hfnet-attempt-v5":
...
def wait_with_zero_kf_watchdog(
    ...
    *,
    ...
    def outcome() -> dict[str, object]:
        return {
            "schema_version": "aqua-fe-fair-stability-hfnet-zero-kf-watchdog-outcome-v5",
...
def process_start_receipt(process: subprocess.Popen[bytes], attempt: Mapping[str, Any]) -> dict[str, object]:
    ...
    return {
        "schema_version": "aqua-fe-fair-stability-hfnet-launch-receipt-v5",
        "experiment_id": EXPERIMENT_ID,
        "valid": not errors,
        "errors": errors,
        "pid": process.pid,
...
def run_attempt(case_id: str, budget: int, repeat: int, attempt_index: int = 1) -> dict[str, object]:
    ...
    with open_regular_lock(lock_path) as lock_stream:
        ...
        claim = {
            "schema_version": "aqua-fe-fair-stability-hfnet-start-claim-v5",
            "experiment_id": EXPERIMENT_ID,
        ...
        result = {
            "schema_version": "aqua-fe-fair-stability-hfnet-result-v5",
            "experiment_id": EXPERIMENT_ID,
            "status": status,
